# Seechov Forge — Этот Synth1 банк не существует
...
## Что такое Seechov Forge?

Seechov Forge генерирует новые, ранее не существовавшие пресеты (`.sy1`) для бесплатного VST-синтезатора **Synth1**. Это Wasserstein GAN с градиентным штрафом (WGAN-GP), обученный на фабричном банке, бесплатных банках звуков или любой их комбинации. Код обучения основан на оригинальном проекте [jskripchuk/Synth1GAN](https://github.com/jskripchuk/Synth1GAN) (GPL-3.0).
...
3. Выберите **Output folder** (по умолчанию `Documents/Seechov Forge/presets`).
