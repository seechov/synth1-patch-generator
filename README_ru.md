...
> Windows или Edge могут показать предупреждение «Система Windows защитила ваш
> компьютер». Это нормально для неподписанных open-source бинарников — нажмите
...
В этом репозитории код распространяется под двумя лицензиями:

- **GUI и основной код проекта** — MIT (см. `LICENSE`, © 2026 Aleksei Sychev).
- **Код обучения** (`training/`) — **GPL-3.0**, производная работа от оригинального проекта [jskripchuk/Synth1GAN](https://github.com/jskripchuk/Synth1GAN). Полный текст в `training/LICENSE`.
